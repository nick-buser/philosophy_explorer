...
// Thin CodeMirror-6 wrapper. No syntax highlighting yet (alpha DSL is
// tiny); mainly here for line numbers, bracket matching, history, and
...
export function EgEditor({ value, onChange, className }: Props) {
  ...
  useEffect(() => {
    ...
    // Intentionally mount-only; external `value` changes are handled below.
